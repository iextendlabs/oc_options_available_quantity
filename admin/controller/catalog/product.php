...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['tax_classes'] = $this->model_localisation_tax_class->getTaxClasses();
					...
					if (isset($this->request->post['option_quantity'])) {
						$data['option_quantity'] = $this->request->post['option_quantity'];
					} elseif (!empty($product_info)) {
						$data['option_quantity'] = $product_info['option_quantity'];
					} else {
						$data['option_quantity'] = 1;
					}
